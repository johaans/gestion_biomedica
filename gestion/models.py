...
class equipo(models.Model):
    ...
    archivo_hoja_de_vida=models.FileField(upload_to='uploads/hv/%Y/%m/%d/',null=True,blank=True)
    ...
    archivo_factura=models.FileField(upload_to='uploads/fact/%Y/%m/%d/',null=True,blank=True)
    ...
    arhivo_invima=models.FileField(upload_to='uploads/inv/%Y/%m/%d/',null=True,blank=True)
    importacion=models.CharField(max_length=3,choices=opciones,default=no)
    archivo_importacion=models.FileField(upload_to='uploads/impor/%Y/%m/%d/',null=True,blank=True)
